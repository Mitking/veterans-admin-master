...
export default {
  ...
  data() {
    return {
      ...
      operateList: [ // 搜索栏项目
        { title: '查询列表', show: true, click: this.search, icon: 'el-icon-search', disabled: false, type: 'primary', permission: ['ums:role:getListStore'], width: 80 },
        ...
        { title: '移动端授权', loading: false, show: !this.$attrs.child, click: this.grantMobileMenuButton, icon: 'el-icon-check', disabled: 'isRow', type: 'success', permission: ['ums:role:grantMenu'], width: 80 },
