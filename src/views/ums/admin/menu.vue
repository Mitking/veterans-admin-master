<template>
  <div style="margin:24px">
    <el-form inline size="mini">
      <!--    v-permission="['ums:account:add']" v-permission="['ums:saveOrUpdate']"  -->
      <!-- <el-form-item> -->
      <!-- <el-button type="primary" icon="el-icon-plus" @click="formType='insertD';currentRow={id:null};formShow=true">添加目录(D)</el-button> -->
      <!-- </el-form-item> -->
      <el-form-item>
...
import BaseProps from '@/views/ums/admin/components/menu/BaseProps'
import Buttons from '@/views/ums/admin/components/menu/Buttons'
