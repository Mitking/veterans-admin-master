<template>
  <div style="margin: 24px">
    ...
    <el-form inline size="mini">
      <el-form-item>
        <el-button v-permission="['ums:user:saveOrUpdate']" type="primary" icon="el-icon-plus" @click="insert">添加</el-button>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['ums:user:updatePwd']" :disabled="!currentRow.id || currentRow.username === 'admin'" icon="el-icon-edit" @click="update">修改</el-button>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['ums:user:grantRole']" :disabled="!currentRow.id || currentRow.username === 'admin'" type="info" icon="el-icon-s-custom" @click="openRoleInfo">分配角色</el-button>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['ums:user:updatePwd']" :disabled="!currentRow.id || currentRow.username === 'admin'" type="info" icon="el-icon-s-custom" @click="updatePasswordShow = true">
          修改密码
        </el-button>
      </el-form-item>
      <el-form-item>
