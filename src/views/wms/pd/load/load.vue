...
import { getPage, deleteOrders, review } from '@/api/wms/pdload'
...
export default {
  ...
  data() {
    return {
      ...
      searchList: [ // 搜索栏项目
        ...
        { title: '车型', prop: 'carType', type: 'select', selectData: 'CAR_TYPE', width: '300px' },
        { title: '装车单号', prop: 'pdLoadCarNo', type: 'text', width: '300px' },
        { title: '创建者', prop: 'creator', type: 'text', width: '300px' },
        { title: '审核人id', prop: 'reviewerId', type: 'text', width: '300px' },
        { title: '发车日期', prop: 'startDate', type: 'date', width: '300px' }
      ],
      operateList: [ // 操作栏项目
  ...
  methods: {
    ...
    del(operateItem = {}) {
      ...
      this.$confirm(`此操作将永久删除${this.mix_comp_find_order_title_name('pdLoadCarNo', this.$attrs['form-data'])}「${this.currentRow.pdLoadCarNo}」, 是否继续?`, '提示', {
