...
import { getPage, deleteOrders, review } from '@/api/wms/purprice'
export default {
  name: 'Order',
  components: { User },
  // 全局常用字段
  ...
  data() {
    return {
      ...
      searchList: [ // 搜索栏项目
        ...
        { title: '单据号', prop: 'purPriceOrderNo', type: 'text', width: '300px' },
      ...
      operateList: [ // 操作栏项目
        ...
        { title: '审核', show: true, prop: 'edit', click: this.reviews, loading: false, icon: 'el-icon-edit-outline', disabled: 'ids', type: 'primary', permission: ['ums:role:grantMenu', 'ums:role:page'], width: 80 }
