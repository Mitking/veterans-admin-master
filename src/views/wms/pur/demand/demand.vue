...
import { getPage, deleteOrders, review } from '@/api/wms/purdemand'
    ...
    return {
      ...
      operateTableList: [
        ...
        },
        {
          ...
          type: 'primary',
          permission: ['wms:pur:demand:order:save'],
          width: 80
        }
      ],
      searchList: [
        ...
        { title: '需求门店', prop: 'storeId', type: 'select', disabled: true, defaultValue: this.$store.state.user.storeId, selectData: 'stores', selectOption: { label: 'name', value: 'id' }, width: '300px' },
        {
          title: '审核状态',
          prop: 'auditStatu',
          defaultValue: 0,
      ...
      operateList: [
        ...
        },
        {
          ...
          disabled: 'idsNoRevEd',
          type: 'primary',
          permission: ['wms:pur:demand:order:delete'],
          width: 80
        },
        // {
        //   title: '审核',
        //   show: true,
        //   prop: 'edit',
        //   click: this.$listeners.review,
        //   loading: false,
        //   icon: 'el-icon-s-check',
        //   disabled: 'isRowNoRevEd',
        //   type: 'primary',
        //   permission: ['wms:pur:demand:order:reviewer'],
        //   width: 80
        // },
        // {
        //   title: '批量删除',
