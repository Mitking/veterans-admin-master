...
import { getPage, deleteOrders, review } from '@/api/wms/purreceive'
  ...
  data() {
    return {
      ...
      searchList: [ // 搜索栏项目
        ...
        { title: '收货门店ID', prop: 'storeId', type: 'text', width: '300px' },
        { title: '收货仓库ID', prop: 'stockId', type: 'text', width: '300px' },
        { title: '供应商ID', prop: 'supplierId', type: 'text', width: '300px' },
