...
import AlgSelect from '@/views/core/product/pricealg/algteam/algselect.vue'
export default {
  name: 'WmsAddCardForm',
  components: { ProductIndex, StoreProductIndex, SupplierIndex, DiffAutoSelect, AlgSelect },
  data() {
    return {
