...
import { getPage } from '@/api/oms/card/flowing'
export default {
  name: 'CardFlowingIndex',
  components: {},
  // 全局常用字段
  mixins: [MixinGlobal],
  data() {
    return {
      searchList: [ // 搜索栏项目
        ...
        // { title: '卡状态', prop: 'state', type: 'select', selectData: 'card_status', width: '300px' },
        // { title: '组织编号', prop: 'orgId', type: 'select', width: '300px' },
        // { title: '所属门店ID', prop: 'storeId', type: 'select', selectData: 'stores', width: '300px' },
      ...
      operateList: [ // 操作栏项目
        ...
        // { title: '导出', show: !this.$attrs.child, prop: 'insert', click: this.output, loading: false, icon: 'el-icon-plus', disabled: 'ids', type: 'primary', permission: ['ums:role:saveRole', 'ums:role:page'], width: 80 }
        // { title: '批量挂失', show: !this.$attrs.child, prop: 'edit', state: '1', click: this.reviews, loading: false, icon: 'el-icon-edit-outline', disabled: 'ids', type: 'primary', permission: ['ums:role:grantMenu', 'ums:role:page'], width: 80 },
        // { title: '批量解挂', show: !this.$attrs.child, prop: 'edit', state: '4', click: this.reviews, loading: false, icon: 'el-icon-edit-outline', disabled: 'ids', type: 'primary', permission: ['ums:role:grantMenu', 'ums:role:page'], width: 80 },
        // { title: '批量锁卡', show: !this.$attrs.child, prop: 'edit', state: '2', click: this.reviews, loading: false, icon: 'el-icon-edit-outline', disabled: 'ids', type: 'primary', permission: ['ums:role:grantMenu', 'ums:role:page'], width: 80 },
        // { title: '批量解锁', show: !this.$attrs.child, prop: 'edit', state: '4', click: this.reviews, loading: false, icon: 'el-icon-edit-outline', disabled: 'ids', type: 'primary', permission: ['ums:role:grantMenu', 'ums:role:page'], width: 80 }
      ...
      table_data_arr: [ // 所有字段 show：在表格中显示，formShow：在详情中显示，defaultValue：默认值
        ...
        { title: '卡面号', prop: 'faceNo', show: true, type: 'text', editShow: true, detailShow: true, addFatherProp: 'Req', readonly: true },
        // { title: '卡号', prop: 'cardNo', show: true, type: 'text', editShow: true, detailShow: true, addFatherProp: 'Req', readonly: true },
        { title: '组织', prop: 'orgId', width: 200, show: true, type: 'select', selectData: 'organizes', selectOption: { label: 'orgShortName', value: 'id' }, editShow: true, detailShow: true, addFatherProp: 'Req', readonly: true },
        { title: '所属门店', prop: 'storeId', width: 200, show: true, type: 'select', selectData: 'stores', fatherProp: 'organizes', fatherPropName: 'orgId', selectOption: { label: 'name', value: 'id' }, editShow: true, detailShow: true, addFatherProp: 'Req', readonly: true },
        { title: '操作类型', prop: 'flowingType', width: 100, show: true, type: 'select', selectData: 'card_status', editShow: true, detailShow: true, addFatherProp: 'Req' },
        { title: '日期', prop: 'flowingDate', width: 150, show: true, type: 'text', editShow: false, detailShow: true, addFatherProp: 'Req' }
      ],
      ids: [],
