...
import { addTag, updateTag } from '@/api/core/tag'
import CoreForm from '@/views/core/components/CoreForm'
import Order from './tag.vue'
export default {
  name: 'TagIndex',
  ...
  data() {
    return {
      ...
      table_data_arr: [ // 所有字段 show：在表格中显示，formShow：在详情中显示，defaultValue：默认值
        ...
        { title: '标签', prop: 'tagName', show: true, type: 'text', editShow: true, addFatherProp: 'Req',
          rule: [{ required: true, message: '标签名必填', trigger: 'change' }] },
